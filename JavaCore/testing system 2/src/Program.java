...
public class Program {
	...
	public static void main(String[] args) {
		...
		System.out.println(acc2.id+"	"+acc2.username+"	"+acc2.fullName+"	"+acc2.email+"		"+acc2.departmentID.name+"		"+acc2.positionID.name+"		"+acc2.createDate);
		System.out.println(acc3.id+"	"+acc3.username+"	"+acc3.fullName+"		"+acc3.email+"		"+acc3.departmentID.name+"		"+acc3.positionID.name+"		"+acc3.createDate);
		System.out.println();
		...
		System.out.println(gr2.id+"	"+gr2.name+"	"+gr2.creatorID.fullName+"		"+gr2.createDate);
		System.out.println(gr3.id+"	"+gr3.name+"	"+gr3.creatorID.fullName+"	"+gr3.createDate);
		System.out.println();
		...
		System.out.println(cate2.id+ "	"+cate2.categoryName );
		System.out.println(cate3.id+ "	"+cate3.categoryName );
		System.out.println();
